                ...
                <div className="container">
                    <div>
                        <div className="border-left border-right border-bottom border-dark row">
                            ...
                            MY ITEM {this.props.match.params.itemName.slice(0,-4)}
                            </strong>
                        </div>
                        <div>
                            ...
                            <div className="d-flex justify-content-between my-3">
                                ...
                                <div className="col-sm-5">
                                    <Link to={"/upload-detail/"+this.props.match.params.itemName}><button type="button" className="float-right border border-dark btn-outline-dark">Upload Photos</button></Link>
                                </div>
                            </div>
                        </div>
                    </div>
