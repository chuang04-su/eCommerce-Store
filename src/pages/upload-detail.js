...
export default class UploadDetail extends React.Component {
    ...
    uploadPhotos = (evt) => {
        ...
        for(let f of files) {
            ...
            var fileRef = storageRef.child(this.props.user.uid + '/' + this.props.match.params.itemName + '/' + f.file.name)
            var filesRef = storageRef.child('images/' + this.props.match.params.itemName + '/' + f.file.name)
                    ...
                    <div className="container">
                        <div className="container-fluid">
                            <div className="d-flex justify-content-between py-2">
                                <div className="brand">
                                    <h1 className="h3">upload {this.props.match.params.itemName.slice(0,-4)} photos</h1>
                                </div> 
                                <div>
